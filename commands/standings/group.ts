import { ActionRowBuilder, ButtonBuilder, ButtonStyle, type ChatInputCommandInteraction, Colors, EmbedBuilder, SlashCommandBuilder } from "discord.js";
import type { Groups } from "../../lib/types.ts";
...
export const data = new SlashCommandBuilder()
	...
	.addStringOption((input) => input.setName("tournament").setRequired(true).setDescription("Enter tournament page link here."));
export async function execute(interaction: ChatInputCommandInteraction) {
	...
	const sendToChat = new ButtonBuilder().setStyle(ButtonStyle.Primary).setLabel("Send to chat").setCustomId("stc");
