...
export class InvalidPlayerTagError extends Error {
	constructor() {
		super();
		this.name = "Player Tag Error";
		this.message = "Invalid player tag provided.";
	}
}
export class InvalidClubTagError extends Error {
	constructor() {
		super();
		this.name = "Club Tag Error";
		this.message = "Invalid club tag provided.";
	}
}
